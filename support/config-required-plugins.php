...
add_action( 'tgmpa_register', function() {
    ...
    $plugins[] = [
        ...
        'slug' => 'prayer-global-porch-images',
        'source' => 'https://github.com/Pray4Movement/prayer-global-porch-images/releases/latest/download/prayer-global-porch-images.zip',
        'required' => true,
        'version' => 0.1
    ];
     ...
     */
    $config = array(
        'id'           => 'prayer_global',                 // Unique ID for hashing notices for multiple instances of TGMPA.
