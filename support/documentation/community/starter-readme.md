[![Build Status](https://travis-ci.com/Pray4Movement/prayer-global-porch.svg?branch=master)](https://travis-ci.com/Pray4Movement/prayer-global-porch)
...
#### Framework
 ...
 1. Disciple.Tools Theme presence check. ```prayer_global_porch()```
