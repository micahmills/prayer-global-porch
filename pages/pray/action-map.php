...
class Prayer_Global_Prayer_App_Map extends Prayer_Global_Prayer_App {
    ...
    public static function current_lap() {
        ...
        $data_raw = $wpdb->get_results( $wpdb->prepare( "
			...
			LEFT JOIN wp_dt_reports r1 ON r1.grid_id=lg1.grid_id AND r1.type = 'prayer_app' AND r1.timestamp >= %d
            WHERE lg1.level = 0
			...
			LEFT JOIN wp_dt_reports r2 ON r2.grid_id=lg2.grid_id AND r2.type = 'prayer_app' AND r2.timestamp >= %d
            WHERE lg2.level = 1
			...
			LEFT JOIN wp_dt_reports r3 ON r3.grid_id=lg3.grid_id AND r3.type = 'prayer_app' AND r3.timestamp >= %d
            WHERE lg3.level = 2
